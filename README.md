...
Turning off collimation light beam (red flashing strip) provides marginal power saving in scanning mode. Consult <a id="raw-url" href="/doc/GM67_Barcode.pdf">GM67 User manual</a> to see how to do it.
